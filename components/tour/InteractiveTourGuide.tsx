    ...
    return (
        <>
            ...
            <button
                ...
                className="fixed bottom-24 md:bottom-28 right-4 md:right-6 z-50 inline-flex min-h-[44px] items-center gap-2 rounded-full border border-[hsl(var(--accent-purple)/0.4)] bg-card/90 backdrop-blur-xl px-4 py-2.5 text-xs font-display font-bold uppercase tracking-wider text-[hsl(var(--accent-purple))] shadow-xl hover:bg-[hsl(var(--accent-purple)/0.15)] hover:border-[hsl(var(--accent-purple)/0.6)] transition-all cursor-pointer animate-in fade-in duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
            >
