...
export const socialLinks = [
    {
        ...
        hoverClass: "hover:bg-neutral-800 dark:hover:bg-neutral-100 hover:text-white dark:hover:text-black hover:border-transparent"
    },
    {
        icon: Linkedin,
        href: "https://www.linkedin.com/in/ali-haggag7/",
        label: "LinkedIn Profile",
        hoverClass: "hover:bg-[#0A66C2]/10 hover:border-[#0A66C2]/30 hover:text-[#0A66C2]"
    },
    {
        icon: Mail,
