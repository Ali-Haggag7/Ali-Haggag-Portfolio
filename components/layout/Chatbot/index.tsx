...
export default function Chatbot() {
    ...
    return (
        <section aria-label="AI Assistant" className="fixed bottom-4 left-4 md:left-auto md:right-6 md:bottom-6 z-50 flex flex-col items-start md:items-end">
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="relative mb-4 w-[calc(100vw-2rem)] sm:w-[400px] h-[500px] max-h-[80vh] flex flex-col overflow-hidden rounded-2xl border border-border/50 bg-background/95 backdrop-blur-sm shadow-2xl origin-bottom-left md:origin-bottom-right"
                    >
                        <header className="flex items-center justify-between border-b border-border/50 bg-muted/50 p-4">
                        ...
                        <AnimatePresence>
                            {showScrollButton && (
                                <motion.button
                                    ...
                                    className="absolute bottom-[80px] left-1/2 -translate-x-1/2 bg-foreground/90 text-background rounded-full p-2 shadow-lg z-20 hover:bg-foreground active:scale-95 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500"
                                >
                        ...
                        <form
                            ...
                            className="border-t z-10 border-border/50 bg-background p-3"
                        >
            ...
            >
                {isOpen ? (
                    <X className="h-6 w-6 transition-transform rotate-90 duration-300" aria-hidden="true" />
                ) : (
