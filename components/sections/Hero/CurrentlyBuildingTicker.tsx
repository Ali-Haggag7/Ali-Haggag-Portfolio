...
export const CurrentlyBuildingTicker = memo(function CurrentlyBuildingTicker() {
    ...
    return (
        <button
            ...
            className="mb-4 inline-flex items-center gap-2 rounded-full border border-purple-500/40 bg-purple-500/10 dark:bg-purple-500/15 px-4 py-2 text-xs font-mono text-purple-700 dark:text-purple-300 shadow-sm transition-all hover:bg-purple-500/20 hover:border-purple-500/60 cursor-pointer min-h-[44px]"
        >
            ...
            <ArrowRight className="h-3.5 w-3.5 text-purple-600 dark:text-purple-400" aria-hidden="true" />
        </button>
    );
});
