...
export const ScarCard = memo(function ScarCard({ scar, index, isExpanded, onToggle }: ScarCardProps) {
    ...
    return (
        <motion.div
            ...
            className={cn(
                "group rounded-2xl border transition-colors duration-200 overflow-hidden",
                isExpanded
        ...
        >
            <button
                ...
                className="w-full flex items-center justify-between p-6 text-left focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-inset cursor-pointer"
            >
                ...
                <div className={cn(
                    "flex items-center justify-center w-8 h-8 rounded-full transition-transform duration-200 shrink-0 bg-muted/50 transform-gpu",
