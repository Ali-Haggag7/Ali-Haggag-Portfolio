...
export const technicalArsenal: SkillCategory[] = [
    ...
    },
    {
        ...
        skills: [
            ...
            { name: "Supabase", icon: "/skills/supabase.svg", status: "Production Ready", projects: ["E-commerce Lab"], scarId: null },
            { name: "PostgreSQL", icon: "/skills/postgresql.svg", status: "Production Ready", projects: ["E-commerce Lab"], scarId: null },
